...
SCRAPER_DECISIONS_OUTPUT_S3_PREFIX = 'ingestion/output/' # 'ingestion/output/' ideally
SCRAPER_DECISIONS_OUTPUT_S3_PREFIX_CLEAN = 'clean/' # 'clean/' ideally
SCRAPER_DECISIONS_OUTPUT_S3_PREFIX_CLEAN_REDUCED = 'clean_reduced/' # 'clean_reduced/' ideally
SCRAPER_DECISIONS_OUTPUT_S3_BUCKET = 'rushil-test'
